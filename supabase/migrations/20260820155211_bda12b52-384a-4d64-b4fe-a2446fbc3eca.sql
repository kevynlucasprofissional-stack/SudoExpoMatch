...
BEGIN
  ...
  -- Fonte autoritativa de consentimento: public.consents (registro mais recente).
...
BEGIN
  ...
  IF v_id IS NULL THEN
    -- Colunas legadas (whatsapp/offers/needs/consent/recovery_code) não são mais
    -- escritas: contato e recuperação vivem no schema private, ofertas/necessidades
    -- em profile_offers/profile_needs e consentimento em public.consents.
