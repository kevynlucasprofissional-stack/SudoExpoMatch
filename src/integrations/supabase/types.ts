...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      connection_events: {
        Row: {
          ...
          note: string | null;
          previous_status: Database["public"]["Enums"]["connection_status"] | null;
        };
        Insert: {
          action: string;
          actor_user_id?: string | null;
    ...
    Enums: {
      ...
      match_kind: "direto" | "inverso" | "bidirecional" | "complementar" | "hibrido";
      match_label: "alta_compatibilidade" | "boa_oportunidade" | "conexao_possivel";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
