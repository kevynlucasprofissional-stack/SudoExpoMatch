...
import { createTtlCache } from "@/lib/social-context";
...
const memory = createTtlCache<any>(50);
...
const deps2 = { provider, memory: createTtlCache<any>(50), store, analyzer } as any;
