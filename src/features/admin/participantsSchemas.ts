...
export const participantDetailSchema = z.object({
  profile: z.object({
    ...
    target_business_size: z.string().nullable().default(null),
    target_business_type: z.string().nullable().default(null),
    target_segment_id: z.string().nullable().default(null),
    target_segment_label: z.string().nullable().default(null),
    is_demo: z.boolean(),
    created_at: z.string(),
    updated_at: z.string(),
  }),
